                    ...
                    <div className="space-y-2">
                        <div className="flex gap-2">
                            <div className="flex-1">
                                <label htmlFor="cover-type" className="block text-sm font-medium text-sage-600 mb-1">Cover type</label>
                                <select
                                    id="cover-type"
                                    value={coverType}
                            ...
                            <div className="flex-1">
                                <label htmlFor="cover-value" className="block text-sm font-medium text-sage-600 mb-1">Cover value</label>
                                <input
                                    id="cover-value"
                                    value={coverValue}
